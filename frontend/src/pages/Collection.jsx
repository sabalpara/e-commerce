...
const Collection = () => {
  ...
  const [sortval,setSortval]=useState('relevant');
...
const applyFilter = () => {
 ...
 if (showSearch && search) {
  ...
  },[category,subCategory,sortval,search,showSearch,products]);
  ...
  <div className='flex justify-between mb-4 text-base sm:text-2xl'>
    ...
    {/* Product Sort */}
    <select onChange={(e)=>(setSortval(e.target.value))} className='px-2 text-sm border-2 border-gray-300'>
